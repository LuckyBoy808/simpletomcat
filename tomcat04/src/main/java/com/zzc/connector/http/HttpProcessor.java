...
/**
 * @description 创建Request和Response （this class used to be called HttpServer）
 * @author zzc
 * @create 2020-04-15 17:10
 */
public class HttpProcessor implements Lifecycle, Runnable {
    ...
    /**
     * Is there a net socket available?
     */
    ...
    private synchronized Socket await() {
        // Wait for the Connector to provide a net Socket
        while (!available) {
            try {
                wait();
